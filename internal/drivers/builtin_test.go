...
func TestBuiltin_AllRegistered(t *testing.T) {
	...
	for _, want := range []string{"aruba_hpe", "cisco_ios", "huawei_vrp", "host_snmp", "fortigate", "vmware_esxi", "cctv", "wlan_controller", "redfish_bmc", "vmware_vsphere", "printer_snmp", "ups_snmp"} {
		if !got[want] {
