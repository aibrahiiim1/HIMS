...
const VENDORS: VendorDef[] = [
  ...
  { type: 'extreme_xcc', label: 'Extreme XCC (on-prem ExtremeCloud IQ Controller)', group: 'Wireless', urlLabel: 'Controller URL', urlHint: 'https://172.21.96.100:8443', fields: [{ key: 'api_base', label: 'API base path (auto-discovered by Test)', hint: '/management/v1' }], insecure: true, note: 'On-prem ExtremeCloud IQ Controller (VE6120). Use admin/API credentials. Run Test Connection first — it safely discovers the API path/auth and saves it; then Run Collection pulls AP/SSID/client data.' },
