...
const VENDORS: VendorDef[] = [
  ...
  { type: 'wireless_extreme', label: 'Extreme (ExtremeCloud IQ)', group: 'Wireless', urlLabel: 'XIQ API URL', urlHint: 'https://api.extremecloudiq.com', fields: [{ key: 'api_base', label: 'API base path', hint: '/' }], insecure: true },
