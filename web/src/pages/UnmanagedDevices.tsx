...
const REASON_ACTION: Record<string, string> = {
  ...
  vsphere_credential_required: 'The ESXi/vSphere host REJECTED the bound credential (SSH and the vSphere API both rejected it). Provide the correct ESXi root password for THIS host — it differs from the other ESXi hosts on the subnet. HIMS tries the bound credential ALONE (it will not spray, to avoid locking the ESXi root account); bind the correct root credential and re-collect.',
}
